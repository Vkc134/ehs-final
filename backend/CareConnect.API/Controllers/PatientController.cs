...
namespace CareConnect.API.Controllers
{
    ...
    public class PatientController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdatePatient(int id, [FromBody] UpdatePatientDto dto)
        {
            ...
            // Update fields
            patient.PatientFirstName = dto.PatientFirstName;
            patient.PatientLastName = dto.PatientLastName;
            patient.Gender = dto.Gender;
            patient.PhoneNumber = dto.PhoneNumber;
            patient.Email = dto.Email;
            patient.Address = dto.Address;
            patient.BloodGroup = dto.BloodGroup;
            patient.IsVyasa = dto.IsVyasa;

            if (!string.IsNullOrWhiteSpace(dto.DateOfBirth) && DateTime.TryParse(dto.DateOfBirth, out var dob))
            {
